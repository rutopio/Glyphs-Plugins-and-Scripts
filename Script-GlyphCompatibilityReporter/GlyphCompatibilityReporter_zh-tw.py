#MenuTitle: Glyph Compatibility Reporter zh-tw
#Created by ChingRu
# -*- coding: utf-8 -*-
__doc__="""
...
#			{glyph.name} No. {idx} shape might has compatibility problem due to the wrong position.
